...
type Consumer interface {
	Consume()
	Status(*config.AppConfig, monitoring.MetricsI) error
	worker(int)
...
func NewConsumer(sqsSvc sqsiface.SQSAPI, appConfig *config.AppConfig, d database.Db, m monitoring.MetricsI) Consumer {
...
func (c *consumer) Status(appConfig *config.AppConfig, m monitoring.MetricsI) error {
